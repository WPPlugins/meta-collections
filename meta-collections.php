...
public function __construct(){
	...
	*/
	...
	if($pagenow=="edit.php" && isset($_GET[post_type]) && $_GET[post_type]!="page" && $_GET[post_type]!="post" ){ //concerns a custom page type
	...
	//add_action('admin_footer', array( $this, 'postscripts') );//drag and drop interface for the future order field;
	}
